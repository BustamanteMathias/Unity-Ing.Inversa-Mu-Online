    ...
    public class UDP
    {
        ...
        public void SendData(Packet _packet)
        {
            ...
            catch (Exception _ex)
            {
                ...
                Debug.Log($"Error enviando la data al servidor desde UDP: {_ex}");
            }
        }
    ...
    private void InitializeClientData()
    {
        try
        {
          packetHandlers = new Dictionary<int, PacketHandler>()
          {
            ...
            { (int)ServerPackets.enemyDropItem, ClientHandle.EnemyDropItem },
            { (int)ServerPackets.npcSpawn, ClientHandle.NPCSpawn },
            { (int)ServerPackets.npcPosition, ClientHandle.NPCPosition },
            { (int)ServerPackets.npcRotatiom, ClientHandle.NPCRotation },
